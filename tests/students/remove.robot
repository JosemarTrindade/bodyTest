...
Cenario: Remover aluno cadastrado
    ...
    &{student}      Create Dictionary   name=Robert Pattinson   email=batman@dc.com       age=27      weight=90      feet_tall=1.80          
...
Cenario: Desistir de excluir

    &{student}      Create Dictionary   name=Robert Downey Jr   email=ironman@marvel.com       age=27      weight=90      feet_tall=1.80          
